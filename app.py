...
# =========================================================
    ...
    if "current_gift_room" in st.session_state and st.session_state["current_gift_room"]:
        ...
        if not room_doc.exists:
            ...
            if room["status"] == "waiting":
                ...
                if st.button("確認簽到加入", key="btn_g_confirm"):
            ...
            # 已配對開獎
                ...
                if st.button("揭曉送禮對象 🎯", key="btn_reveal_gift"):
    ...
    # 交換禮物專區：三個主要按鈕
        ...
        if action == "menu":
            ...
            if st.button("確認建立並進入 🚀", type="primary", key="btn_act_c_g"):
    ...
    if "current_lotto_room" in st.session_state and st.session_state["current_lotto_room"]:
        ...
        if not l_doc.exists:
            ...
            if l_room["status"] == "waiting":
                ...
                if st.button("簽到加入抽獎", key="btn_l_confirm"):
                    if not l_join_name:
                        st.error("名字不能為空！")
